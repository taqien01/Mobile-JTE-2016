...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClick (View view){
        ...
        ImageButton atas = (ImageButton) findViewById(R.id.atas);
        ImageButton bawah = (ImageButton) findViewById(R.id.bawah);
        ImageButton kanan = (ImageButton) findViewById(R.id.kanan);
        ImageButton kiri = (ImageButton) findViewById(R.id.kiri);
        ...
        atas.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                hasil.setText(hasil.getText() + "(0,1)");
        ...
        kiri.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                hasil.setText(hasil.getText() + "(-1,0)");
